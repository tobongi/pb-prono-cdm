  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-6 relative pb-pattern-bg">
      ...
      <div className="relative z-10 flex flex-col items-center gap-8 w-full max-w-sm">
        <img src="/pb-logo-white-circle.png" alt="PB Poulet Braisé" className="w-32 h-32" />
        ...
        <div className="flex flex-col gap-3 w-full">
          ...
          {/* Instagram — utilise Facebook OAuth (même compte Meta) */}
          <button
            onClick={() => signInWith('facebook')}
            className="flex items-center justify-center gap-3 text-white font-display text-lg uppercase px-6 py-4 rounded-xl transition-colors"
            style={{
